...
chmod 777 ./Deployment/BuildScriptsAuto/buildAndPublishAllServices.sh
...
./Deployment/BuildScriptsAuto/buildAndPublishAllServices.sh $userName

sudo cp $homeFolder/engaze/git/Infra/Deployment/BuildScriptsAuto/nginx-sitesenabled-default /etc/nginx/sites-enabled/default
systemctl restart nginx

#ps aux | grep dotnet
#kill -9 14470
#/home/ubuntu/engaze/git/Infra/Deployment/BuildScriptsAuto/buildAndPublishAllServices.sh