...
chmod 777 /home/$1/engaze/git/Infra/Deployment/BuildScriptsAuto/build-publish-api-event.sh
...
/home/$1/engaze/git/Infra/Deployment/BuildScriptsAuto/build-publish-api-event.sh $1 
